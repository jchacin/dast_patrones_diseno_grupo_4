...
namespace Generación_de_Infomes
{
    internal class Html : Informe
    {
        ...
        {
            Console.WriteLine("Enviando reporte de los datos obtenidos en formato Html\n");
            //Se usan los datos formateados
        }

        protected override void ExtraerData(string ObjetoDatos)
        {
            Console.WriteLine($"Extrayendo datos de la base de datos para {ObjetoDatos}");
            //Se retornan los datos obtenidos a la variable datos
        }

        protected override void FormatearResultado(string ObjetoDatos)
        {
            Console.WriteLine($"Formateando resultado del informe de {ObjetoDatos} en Html");
        }
    }
}
